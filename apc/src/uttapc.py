...
"""
LSTM + Utterance-level Modelling Model:
...
class UtteranceLevelAPC(torch.nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout=0.0, 
                 config_residual=True, use_var=True, merge_mode="squeeze", sq_ratio = 2, utterance_level_dropout=None):
        super().__init__()
    ...
    def forward(self, feat, length, device):
        ...
        return post_frm_embeddings, self.proj(post_frm_embeddings), utt_embeddings, pre_frm_embeddings